...
Read/watch before each session — concept walkthrough + quiz assumes one pass through the material. Video is primary (visual learning preference); articles supplement. Links verified 2026-09-06; paywalled Medium link replaced + video refs added 2026-09-11.
...
| 1.3 — Positional encoding | [Raschka — Positional info FAQ](https://sebastianraschka.com/faq/docs/positional-information-transformer.html) (skim after watching) | 🎥 [DataMListic — Why RoPE Rotates Instead of Adds](https://www.youtube.com/watch?v=EA24K07lH0Y) (4:42; best 5-min intuition — sinusoidal clock analogy → relative-distance geometry) · 🎥 [DeepLearning Hero — RoPE explained](https://www.youtube.com/watch?v=GQPOtyITy54) (14:06; full: what breaks with sinusoidal, block-diagonal rotation, extrapolation) · [Transformer Explainer (interactive)](https://poloclub.github.io/transformer-explainer/) |
| 1.4 — KV cache | [Lilian Weng — LLM Inference Optimization](https://lilianweng.github.io/posts/2023-01-10-inference-optimization/) (KV cache section) · [HF Transformers — Cache strategies](https://huggingface.co/docs/transformers/kv_cache) | — |
